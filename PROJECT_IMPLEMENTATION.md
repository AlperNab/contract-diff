# Contract Diff — Standalone Real GUI Implementation
...
Default URL: `http://127.0.0.1:9111`

## What is inside this project folder

- `app/` — FastAPI backend for this project.
- `static/` — elegant browser GUI.
- `plugins/contract-diff.json` — this project’s own feature/customization/input schema.
...
- `clause_playbook` — clause playbook (textarea)
...
- `two_contract_versions` — Two contract versions (text) required

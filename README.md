...
|---|---:|:---:|---|---|
| `two_contract_versions`<br>Two contract versions | text | Yes | — | Affects input: Two contract versions. |
...
| `clause_playbook`<br>clause playbook | textarea | No | — | Affects customization: clause playbook. |
...
| `AI_SUITE_PORT` | Port for this project GUI, default `9111`. |
